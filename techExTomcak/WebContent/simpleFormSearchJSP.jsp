...
<body>
	...
	<%!String runMySQL() throws SQLException {
		...
		try {
			connection = DriverManager.getConnection("jdbc:mysql://ec2-18-188-219-3.us-east-2.compute.amazonaws.com:3306/myDB", "ctomcakRemote", "Bro52Eve");
	...
	<a href=/techExTomcak/simpleFormSearchJSP.html>Search Data</a> <br>
</body>
</html>